...
class Program{
    public static void Main(string[] args)
    {
        ...
        // Create a object for Bubblesort
        BubbleSort bubbleSort=new BubbleSort();
        // Calling AscendingBubbleSort() mehtod for different Parameter
        bubbleSort.AscendingBubbleSort(number);
        bubbleSort.AscendingBubbleSort(employeeID);
        bubbleSort.AscendingBubbleSort(alphabets);
        bubbleSort.AscendingBubbleSort(numbers);
        ...
        bubbleSort.DescendingBubbleSort(number);
        bubbleSort.DescendingBubbleSort(employeeID);
        bubbleSort.DescendingBubbleSort(alphabets);
        bubbleSort.DescendingBubbleSort(numbers);
