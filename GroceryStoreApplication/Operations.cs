    ...
    public static class Operations
    {
        ...
        public static void UserRegistration()
        {
            ...
            while (!valid)
            {
                ...
                if (!valid)
                {
                    Console.WriteLine($"Invalid Format Enter Again (Male ,Female, Transgender) : ");
                }
            }
            ...
            while (!valid)
            {
                ...
                if (!valid)
                {
                    Console.WriteLine($"Invalid Format Enter Again (dd/MM/yyyy) : ");
                }
            }
            ...
            CustomerRegistration customerRegistration = new CustomerRegistration(balance, name, fatherName, gender, mobile, dOB, mailID);
