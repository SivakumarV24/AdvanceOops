...
namespace HierarchicalInheritance
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Create a objecct For Customer Details
            CustomerDetails customer=new CustomerDetails(10000,personalDetails.UserID,personalDetails.Name,personalDetails.FatherName,personalDetails.Gender,personalDetails.PhoneNumber);    
        }
    }
}
